        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="mb-0"><i class="fas fa-user-tag me-2 text-primary"></i>Form Tambah Role</h5>
                </div>
            </div>
            <div class="card-body p-4">
                <form action="{{ route('admin.roles.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <small class="text-muted">Gunakan huruf kecil tanpa spasi, contoh: admin, bendahara</small>
                    </div>
