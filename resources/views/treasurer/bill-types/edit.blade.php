        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4">
                    <form action="{{ route('treasurer.bill-types.update', $billType) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          name="description" 
                                          rows="3"
                                          placeholder="Deskripsi jenis tagihan...">{{ old('description', $billType->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="amount" 
                                           name="amount" 
                                           value="{{ old('amount', $billType->amount) }}"
                                           min="0"
                                           step="1000"
                                           required>
                                    @error('amount')
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch mt-4">
                                    <input type="checkbox" 
                                           ...
                                           name="is_flexible" 
                                           value="1"
                                           {{ old('is_flexible', $billType->is_flexible) ? 'checked' : '' }}>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <div class="mt-2">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_mandatory" id="mandatory_yes" value="1" {{ old('is_mandatory', $billType->is_mandatory) == '1' || old('is_mandatory', $billType->is_mandatory) === true ? 'checked' : '' }}>
                                        <label class="form-check-label" for="mandatory_yes">
                                            <span class="badge bg-danger">Wajib</span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="is_mandatory" id="mandatory_no" value="0" {{ old('is_mandatory', $billType->is_mandatory) == '0' || old('is_mandatory', $billType->is_mandatory) === false ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-control bg-light">
                                    ...
                                    {{ $billType->bills_count ?? $billType->bills()->count() }} tagihan
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <div class="form-check form-switch">
                                    <input type="checkbox" 
                                           ...
                                           name="is_recurring" 
                                           value="1"
                                           {{ old('is_recurring', $billType->is_recurring) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6" id="recurring-period-wrapper" style="display: none;">
                                ...
                                <select class="form-select @error('recurring_period') is-invalid @enderror" 
                                    ...
                                    <option value="monthly" {{ old('recurring_period', $billType->recurring_period) == 'monthly' ? 'selected' : '' }}>Bulanan</option>
                                    <option value="quarterly" {{ old('recurring_period', $billType->recurring_period) == 'quarterly' ? 'selected' : '' }}>Triwulan</option>
                                    <option value="semester" {{ old('recurring_period', $billType->recurring_period) == 'semester' ? 'selected' : '' }}>Semester</option>
                                    <option value="yearly" {{ old('recurring_period', $billType->recurring_period) == 'yearly' ? 'selected' : '' }}>Tahunan</option>
                                </select>
